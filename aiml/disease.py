disease_dic = {
    ...
    # 'कॉर्न (मक्का)___सामान्य जंग (कॉर्न का फफूंद)_':""" <b>फसल</b>: कॉर्न (मक्का) <br/>
    #   रोग: सामान्य जंग (कॉर्न का फफूंद)<br/>

    # <br/><br/>कॉर्न का सामान्य जंग, फंगस प्यूसिनिया सोर्गी द्वारा कारण होता है, संयुक्त राज्य अमेरिका में कॉर्न की दो प्रमुख जंग रोगों में से सबसे अधिक होता है, लेकिन यह ओहियो फील्ड (डेंट) कॉर्न में आमतौर पर महत्वपूर्ण उत्पादन की हानि कारण नहीं करता है। कभी-कभी खेती कॉर्न, विशेषकर राज्य के दक्षिणी भाग में, जब मौसम की स्थितियों का फफूंद की विकास और प्रसार को बढ़ावा देती है, तब गंभीरता से प्रभावित हो सकता है।

    # <br/><br/> रोग को रोकने/उपचार करने के तरीके <br/>
    # <br/>1. हालांकि ऑहियो में कॉर्न पर आमतौर पर जंग पाई जाती है, फंगाइसाइड आवश्यकता का अक्सर अवसर नहीं होता है। इसका कारण है कि उच्च रोग प्रतिरोधी फील्ड कॉर्न हाइब्रिड्स उपलब्ध हैं और अधिकांश में कुछ मात्रा में प्रतिरोध होता है।

    # <br/>2. हालांकि, पॉपकॉर्न और मीठे कॉर्न काफी संवेदनशील हो सकते हैं। जब सिल्किंग से पहले निचले पत्तियों पर काफी जंग हो और मौसम अच्छा और बर्फीला होता है, तो प्रभावी रोग नियंत्रण के लिए प्रारंभिक फंगाइसाइड आवश्यक हो सकता है। जंग नियंत्रण के लिए कई फंगाइसाइड उपलब्ध हैं। """,
